...
typedef enum {
    ...
    FUNCTION_TELEMETRY_NANOCAM3D = (1 << 8),  // 256
...
#define TELEMETRY_SHAREABLE_PORT_FUNCTIONS_MASK (FUNCTION_TELEMETRY_FRSKY_HUB | FUNCTION_TELEMETRY_LTM | FUNCTION_TELEMETRY_MAVLINK | FUNCTION_TELEMETRY_NANOCAM3D)
